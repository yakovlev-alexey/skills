...
run_id: 2026-07-01-v3
skill_commit: f36ce8cb (pre-pass-2 baseline; skill edits uncommitted at run time)
executor: subagent
reviewer: subagent (one per brief)
trigger: deferred backlog pass 2 (skill-only) — new arcs, hybrid ops, contingencies, governance
